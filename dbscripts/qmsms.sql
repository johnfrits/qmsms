...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2017 at 01:24 PM
...
(188, 160, 5, 1, '2017-09-22 19:23:45');
...
(160, 10, 157, 1001, 1, '2017-09-22 19:19:46');
...
(1, 'Jade', 'admin', 'admin', 'jade@gmail.com', 'Administrator', 5);
...
--
ALTER TABLE `calls`
  MODIFY `CallID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;
--
-- AUTO_INCREMENT for table `counters`
--
ALTER TABLE `counters`
  MODIFY `CountersID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `queues`
  MODIFY `QueueID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;
--
