...
<div class="wrapper">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a style="font-weight: bold;"  class="navbar-brand" id="title-brand">Please choose to get your ticket.</a>
                </div>
            </div>
        </nav>
        ...
        <div class="content">
            ...
            ?>
            <input class="col-sm-4" type="button" value="Print" onclick="PrintDiv();" />
        </div>
