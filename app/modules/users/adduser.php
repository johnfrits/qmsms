...
<body>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
      <label for="inputPassword" class="col-lg-2 control-label">Assigned Counter</label>
      <div class="col-lg-5">
        <input type="text" class="form-control" id="inputAssignedCounter" placeholder="Assigned Counter">
      </div>
    </div>
    <div class="form-group">
